...
so, we essentially reduce human involvement as now experts now only need to construct a table with a small number entries. \fixme{zw: some
of these need to go to introduction.}  In this work, we find that structured  knowledge bases (\KB) already provide a structure table which
