...
-- resulting in a training dataset that is 14x greater than the widely used ACE data set  -- which is smaller, but took \FIXME{xx
man-months} to construct.  We show that the quality of the automatically generated data is comparable to ones that were manually
