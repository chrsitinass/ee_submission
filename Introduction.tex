...
\textbf{Specifically, we leverage Freebase CVT and Wikipedia tables to automatically label texts from a subset of Wikipedia articles.} By
employing \DS, our approach is able to produce a large number of high-quality training instances, resulting in a training dataset that is
14 times greater than the widely used ACE dataset -- which took \FIXME{xx linguists and annotators years} to build\FIXME{~\cite{}}.
