...
Because 68\%  of  arguments in our dataset consist of more than one word, we formulate the training instance in a sequence labeling
paradigm rather than word-level classifications. We tag each word of the sentence using the standard begin-inside-outside (\texttt{BIO})
