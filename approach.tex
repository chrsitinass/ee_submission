...
our future work. While our current implementation targets at sentence-level event detection, there are methods like \FIXME{\cite{}} can be
used to extend our approach to document-level event extraction.
